...
projData3D_analyt = TomoP3D.ModelSinoSub(model, N_size, Horiz_det, Vert_det, (int(0.5 *Vert_det) + 0, int(0.5 *Vert_det) + 10), angles, path_library3D)
...
if plot:
    ...
    plt.imshow(projData3D_analyt[int(0.5 * 10), :, :])
...
print(f"swapped sinogram shape: {projData3D_analyt.shape}")
...
save_nxs("./diamond2_phantom.nxs", angles, swapped_projData3D_analyt, Horiz_det, Vert_det)
